...
RSpec.describe Http::Wrapper::Response do
  ...
  describe "#handle" do
    context "when the response is successful" do
      it "returns the parsed response" do
        ...
        response = Http::Wrapper::Response.new(successful_response)
    ...
    context "when the response is not successful" do
      it "raises the appropriate exception" do
        ...
        response = Http::Wrapper::Response.new(error_response)
  ...
  describe "#response_successful?" do
    ...
    it "returns false for unsuccessful responses" do
      ...
      response = Http::Wrapper::Response.new(unsuccessful_response)
